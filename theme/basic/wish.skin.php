...
<body<?php echo isset($tb['body_script']) ? $tb['body_script'] : ''; ?>>
	...
	<div class="header_mobile">
		<div class="sub_visual">
			<h3 class="back mob"><a href="javascript:history.back()"><img src="/img/header/back.png" alt="뒤로가기"><span>찜목록</span></a></h3>
			<div style="border: 1px solid #f9f9f9;"></div>
			<div class="box">
				<h2 class="sub-vis-tit">찜목록</h2>
				<!-- 구독없을때 -->
			</div>
		</div>
	</div>
	...
	<div class="sub-visual1">
		<div class="box2">
			<p class="sub-vis-con"><span class="sub-vis-span"><?php echo get_text($member['nickname']); ?></span> 님의 <br>찜 목록이에요.</p>


		</div>
	</div>

	<div class="sub-page my-page sub08-02 jjim" id="section">
		<div class="container">
			...
			<!-- Mem_info Area End -->
			<div class="sub08-02-content-wrap content-wrap">
				<!-- Left_box Area Start -->

				<!-- Left_box Area End -->
				<div class="content-box_jjim">
					<!-- <h3><a href="javascript:history.back()"><img src="<?php echo TB_IMG_URL; ?>/m-back.png" alt="뒤로가기"></a>찜목록</h3> -->
					<ul class="wish-list">
						<?php
						for ($i = 0; $row = sql_fetch_array($result); $i++) {
							...
							$ca	=	sql_fetch("select b.* from shop_goods_cate a, shop_cate b where a.gcate = b.catecode and  a.gs_id = '" . $gs["index_no"] . "'");
							$br	=	get_brand_arr($gs["brand_uid"]);

							$it_image	= get_it_image($gs['index_no'], $gs['simg1'], 700, 320);
							$it_price		= get_price($gs['index_no']);
							// 고객선호도 별점수
						...
						?>
							<li class="has-content main-contents">
								<div class="content wish-content cf">
									...
									<div class="text-box fr">
										<div class="top">
											<h3 onclick="location.href='<?= $it_href ?>'"><?= $row["gname"] ?></h3>
					...
					<?php
					if ($i == 0)
						echo '<div class="empty-box"><a href="/"><img src="\img\my_gu\no_fudog.png" alt="img"></a></div>';
					?>
				</div>
	...
	?>          
		...
		<ul>
			...
			$tnb[] = '<li><a href="' . TB_SHOP_URL . '/wish.php"><img src="/img/footer/wish_gugu.png" alt="찜"><span>찜</span></a></li>';
