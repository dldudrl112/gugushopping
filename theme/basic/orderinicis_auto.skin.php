...
require_once(TB_SHOP_PATH.'/inicis/orderform_auto.1.php');
...
<div class="sub-page sub03-02" id="section">
	...
	<!-- Sub_title Area Start -->
		...
		<div class="section1 sec">
			...
			<div class="txt">
				<h3>주문내역을 확인해 주세요.</h3>
				<div class="img-box"><img src="<?php echo TB_IMG_URL; ?>/sub03-02-img.png" alt="img"></div>
			</div>
			<!-- Box Area Start -->
		<?php
		$goods = '';
		...
		for($i=0; $row=sql_fetch_array($result); $i++) {
			...
			//상품 구분 오토빌링 
			$res = query_itemtype($pt_id, 6, " and a.index_no = '".$row['gs_id']."'", $sql_order);
			$goods_item_count = sql_num_rows($res);
		...
		<?php
			...
			require_once(TB_SHOP_PATH.'/inicis/orderform_auto.2.php');
		?>
