...
if(XenoPostToForm::check()) XenoPostToForm::submit($_POST); 

include_once('./_common.php');
include_once(TB_SHOP_PATH.'/settle_inicis.inc.php');
require_once(TB_SHOP_PATH.'/inicis/libs/HttpClient.php');
require_once(TB_SHOP_PATH.'/inicis/libs/json_lib.php');
...
try {
    ...
    if (strcmp('0000', $_REQUEST['resultCode']) == 0) {
        ...
        try {
			...
			$order_action_url		=	TB_SHOP_URL.'/orderformresult.php';
            ...
            if ((strcmp('0000', $resultMap['resultCode']) == 0) && (strcmp($secureSignature, $resultMap['authSignature']) == 0) ) { //결제보안 추가 2016-05-18
                ...
                require TB_SHOP_PATH.'/inicis/INIStdPayResult.php';
                exit;
            } else {
            ...
            alert($netcancelResultString, $page_return_url);
            // 취소 결과 확인
        }
    } else {
