...
*/
	Function Initialize()
	{
		...
		switch($this->server)
		{
			...
			case 'Naver':
				$this->oauth_version = '2.0';
				$this->dialog_url = 'https://nid.naver.com/oauth2.0/authorize?client_id={CLIENT_ID}&response_type=code&redirect_uri={REDIRECT_URI}&state={STATE}';
				$this->access_token_url = 'https://nid.naver.com/oauth2.0/token';
				break;
...
*/
	Function Process()
	{
		...
		if(IsSet($redirect_url))
		{
			...
			echo "<script>
						opener.location.href = decodeURIComponent('".$redirect_url."');
						window.close();
					</script>";
