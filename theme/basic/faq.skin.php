...
<body<?php echo isset($tb['body_script']) ? $tb['body_script'] : ''; ?>>
	...
	<div class="header_mobile">
		<div class="sub_visual">
			<h3 class="back mob"><a href="javascript:history.back()"><img src="/img/header/back.png" alt="뒤로가기"><span>FAQ</span></a></h3>
			<div style="border: 1px solid #f9f9f9;"></div>
			<div class="box">
				<h2 class="sub-vis-tit">FAQ</h2>
				<!-- 구독없을때 -->
			</div>
		</div>
	</div>
...
<div class="sub-page my-page sub07-01" id="section">
    <div class="container">
	<!-- Mem_info Area Start -->
	<?
	...
	<!-- My_box Area Start -->
                <div class="sub07-01-content-wrap content-wrap">
			<!-- Left_box Area Start -->
