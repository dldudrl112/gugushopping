...
<div class="tbl_frm01">
	...
	<tr>
		...
		<td class="td_label">
			<input id="register_use_email" type="checkbox" name="register_use_email" value="1"<?php echo $config['register_use_email']?' checked':''; ?>> <label for="register_use_email">보이기</label>
			<input id="register_req_email" type="checkbox" name="register_req_email" value="1"<?php echo $config['register_req_email']?' checked':''; ?>> <label for="register_req_email">필수입력</label>
		</td>
	</tr>
	<tr>
...
<div class="tbl_frm01">
	...
	<tr>
			<th scope="row">전자금융거래 이용약관<br>(회원가입 시)</th>
			<td><textarea name="shop_electronic" class="frm_textbox wfull" rows="7"><?php echo preg_replace("/\\\/", "", $config['shop_electronic']); ?></textarea></td>
	</tr>
	<tr>
			<th scope="row">만 14세 이상 이용자<br>(회원가입 시)</th>
			<td><textarea name="shop_adult" class="frm_textbox wfull" rows="7"><?php echo preg_replace("/\\\/", "", $config['shop_adult']); ?></textarea></td>
	</tr>
	<tr>
