 ...
 * 1. 라이브러리 인클루드 *
 **************************/
require(TB_SHOP_PATH.'/inicis/libs/INILib.php');
require_once(TB_SHOP_PATH.'/inicis/libs/INIStdPayUtil.php');
require_once(TB_SHOP_PATH.'/inicis/libs/sha256.inc.php');
...
$inipay->SetField("inipayhome", TB_SHOP_PATH.'/inicis'); // 이니페이 홈디렉터리(상점수정 필요)
...
$acceptmethod = 'HPP(2):no_receipt:vbank('.date('Ymd', strtotime("+3 days", TB_SERVER_TIME)).'):below1000'.$useescrow;
...
$returnUrl	=	$siteDomain.'/INIStdPointPayReturn.php';
