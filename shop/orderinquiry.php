...
// 회원인 경우
if($is_member)
    $sql_common = " from shop_order where mb_id = '{$member['id']}' and dan not in (0,6)  and user_ok = 0 ";
else if($od_id && $od_pwd) // 비회원인 경우 주문서번호와 비밀번호가 넘어왔다면
    $sql_common = " from shop_order where od_id = '$od_id' and od_pwd = '$od_pwd' and dan not in (0,6) ";
...
include_once(TB_THEME_PATH.'/orderinquiry.skin.php');
