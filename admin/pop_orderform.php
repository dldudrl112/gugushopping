    ...
    <div id="sodr_pop" class="new_win">
        ...
        <section id="anc_sodr_list">
            ...
            <div class="local_desc02 local_desc">
                <p>
                    주문일시 <strong><?php echo substr($od['od_time'], 0, 16); ?> (<?php echo get_yoil($od['od_time']); ?>
                        )</strong> <span class="fc_214">|</span>
                    주문총액 <strong><?php echo number_format($amount['buyprice']); ?></strong>원
                    <a href="javascript:win_open('<?php echo TB_ADMIN_URL; ?>/order/order_print.php?od_id=<?php echo $od_id; ?>','order_print','670','600','yes');"
                       class="btn_small blue fr"><i class="fa fa-print"></i> 주문서출력</a>
                </p>
            </div>

            <form name="frmorderform" method="post" action="./pop_orderstatusupdate.php"
                    ...
                    <table id="sodr_list">
                        ...
                        for ($i = 0; $row = sql_fetch_array($result); $i++) {
                            ...
                            <tr class="<?php echo $bg; ?>">
                                <td>
                                    <input type="hidden" name="od_no[<?php echo $i; ?>]"
                                           value="<?php echo $row['od_no']; ?>">
                                    <input type="hidden" name="current_status[<?php echo $i; ?>]"
                                           value="<?php echo $row['dan']; ?>">
                                    <label for="chk_<?php echo $i; ?>"
                                           class="sound_only"><?php echo $row['od_id']; ?></label>
                                    <input type="checkbox" name="chk[]" value="<?php echo $i; ?>"
                                           id="chk_<?php echo $i; ?>">
                                </td>
                                <td>
                                    <a href="<?php echo TB_SHOP_URL; ?>/view.php?index_no=<?php echo $row['gs_id']; ?>"
                                       target="_blank"><?php echo get_od_image($row['od_id'], $gs['simg1'], 40, 40); ?></a>
                                </td>
                                <td class="tal">
                                    ...
                                    if (in_array($row['dan'], array(3, 4, 5))) {
                                        ...
                                        <div class="frm_info">
                                            ...
                                            <input type="text" name="delivery_no[<?php echo $i; ?>]"
                                                   value="<?php echo $row['delivery_no']; ?>" class="frm_input w130"
                                                   placeholder="개별 운송장번호">
                                ...
                                <td>
                                    ...
                                    <?php if (in_array($row['dan'], array(7, 9)) && $row['refund_price'] == 0 && in_array($row['paymethod'], array('신용카드', '계좌이체', 'KAKAOPAY'))) { ?>
                                        <p class="padt3"><a
                                                    href="<?php echo TB_ADMIN_URL; ?>/pop_orderpartcancel.php?od_id=<?php echo $row['od_id']; ?>&od_no=<?php echo $row['od_no']; ?>"
                                                    class="btn_ssmall orderpartcancel red">PG부분취소</a></p>
                                    <?php } ?>
                                </td>
                ...
                <div class="local_frm02">
                    <i class="ionicons ion-alert-circled fc_red"></i> 환불, 반품완료 후 <b>"PG부분취소"</b>를 통해 신용카드 및 계좌이체 결제취소를
                    해주셔야 <b>"PG 신용카드 승인취소 처리"</b>가 완료됩니다.
                </div>
                ...
                <?php if ($chk_cnt != $chk_cancel) { // 정상 주문건만 노출 ?>
                    <div class="btn_list marb20">
                        ...
                        <?php if ($chk_cnt == $chk_count1) { // 모두 입금대기 상태인가? ?>
                            <input type="submit" name="act_button" value="입금완료" class="btn_lsmall red"
                                   onclick="document.pressed=this.value">
                            <input type="submit" name="act_button" value="주문취소" class="btn_lsmall white"
                                   onclick="document.pressed=this.value">
                        <?php } else { ?>
                            <input type="submit" name="act_button" value="주문상태저장" class="btn_lsmall red"
                                   onclick="document.pressed=this.value">
                            <?php if ($baesong_run) { ?>
                                <input type="submit" name="act_button" value="운송장번호수정" class="btn_lsmall white"
                                       onclick="document.pressed=this.value">
                            <?php } ?>

                            <?php if ($chk_cnt == $chk_count2) { // 모두 입금완료 상태인가? ?>
                                <input type="submit" name="act_button" value="입금대기" class="btn_lsmall white"
                                       onclick="document.pressed=this.value">
                                <input type="submit" name="act_button" value="전체환불" class="btn_lsmall white"
                                       onclick="document.pressed=this.value">
                            <?php } ?>

                            <?php if ($chk_cnt == $chk_count5) { // 모두 배송완료 상태인가? ?>
                                <input type="submit" name="act_button" value="전체반품" class="btn_lsmall white"
                                       onclick="document.pressed=this.value">
                            <?php } ?>
                        <?php } ?>
                    </div>
                        ...
                        <div class="tbl_frm01">
                            <table>
                                ...
                                <tr>
                                    ...
                                    <td class="td_price fc_197">
                                        (+) <?php echo display_price($amount['baesong']); ?></td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                    ...
                                    <td class="td_price fc_red">
                                        (-) <?php echo display_price($amount['usepoint']); ?></td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                    ...
                                    <td class="td_price bg1 fc_red">
                                        (-) <?php echo display_price($amount['refund']); ?></td>
                                </tr>
                                <tr>
                        ...
                        <div class="tbl_frm01">
                            <table>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <strong><?php echo $od['shop_id']; ?></strong> <?php echo $od['od_mobile'] ? '모바일' : 'PC'; ?>
                                        쇼핑몰에서 주문
                                    </td>
                                </tr>
                                <tr>
                                    <th scope="row"><label for="pt_id">가맹점 ID</label></th>
                                    <td><input type="text" name="pt_id" value="<?php echo $od['pt_id']; ?>" id="pt_id"
                                               class="frm_input"
                                               placeholder="없음"<?php echo $chk_count5 ? ' readonly' : ''; ?>> (배송완료 후
                                        수정불가)
                                    </td>
                                </tr>
                                <tr>
                                ...
                                <?php if (in_array($od['paymethod'], array('무통장', '가상계좌', '계좌이체'))) { ?>
                                    ...
                                    <tr>
                                        ...
                                        <td><input type="text" name="deposit_name"
                                                   value="<?php echo get_text($od['deposit_name']); ?>"
        ...
        <section id="anc_sodr_memo">
            ...
            <form name="frmorderform3" action="./pop_orderformupdate.php" method="post">
                ...
                <textarea name="shop_memo" id="shop_memo" rows="8"
                          class="frm_textbox"><?php echo stripslashes($od['shop_memo']); ?></textarea>
        ...
        <section id="anc_sodr_addr">
            ...
            <form name="frmorderform2" action="./pop_orderformupdate.php" method="post">
                ...
                <input type="hidden" name="subscription_id" value="<?php echo $od['subscription_id']; ?>">
                        ...
                        <div class="tbl_frm01">
                            <table>
                                ...
                                <tr>
                                    ...
                                    <td><input type="text" name="name" value="<?php echo get_text($od['name']); ?>"
                                               id="od_name" required class="frm_input required"></td>
                                </tr>
                                <tr>
                                    <th scope="row"><label for="telephone">전화번호</label></th>
                                    <td><input type="text" name="telephone"
                                               value="<?php echo get_text($od['telephone']); ?>" id="telephone"
                                               class="frm_input"></td>
                                </tr>
                                <tr>
                                    <th scope="row"><label for="cellphone">핸드폰</label></th>
                                    <td><input type="text" name="cellphone"
                                               value="<?php echo get_text($od['cellphone']); ?>" id="cellphone" required
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <input type="text" name="zip" value="<?php echo $od['zip']; ?>" id="zip"
                                               required class="frm_input required" size="5" maxlength="5">
                                        <button type="button" class="btn_small grey"
                                                onclick="win_zip('frmorderform2', 'zip', 'addr1', 'addr2', 'addr3', 'addr_jibeon');">
                                            주소검색
                                        </button>
                                        <br>
                                        <span id="od_win_zip" style="display:block"></span>
                                        <input type="text" name="addr1" value="<?php echo get_text($od['addr1']); ?>"
                                               id="addr1" required class="frm_input required" size="35">
                                        <label for="addr1">기본주소</label><br>
                                        <input type="text" name="addr2" value="<?php echo get_text($od['addr2']); ?>"
                                               id="addr2" class="frm_input" size="35">
                                        <label for="addr2">상세주소</label><br>
                                        <input type="text" name="addr3" value="<?php echo get_text($od['addr3']); ?>"
                                               id="addr3" class="frm_input" size="35">
                                        <label for="addr3">참고항목</label><br>
                                        <input type="hidden" name="addr_jibeon"
                                               value="<?php echo get_text($od['addr_jibeon']); ?>">
                                    </td>
                                </tr>
                                <tr>
                                    <th scope="row"><label for="od_email">E-mail</label></th>
                                    <td><input type="text" name="email" value="<?php echo $od['email']; ?>"
                                               id="od_email" required class="frm_input required" size="30"></td>
                                </tr>
                                <tr>
                        ...
                        <div class="tbl_frm01">
                            <table>
                                ...
                                <tr>
                                    ...
                                    <td><input type="text" name="b_name" value="<?php echo get_text($od['b_name']); ?>"
                                               id="b_name" required class="frm_input required"></td>
                                </tr>
                                <tr>
                                    <th scope="row"><label for="b_telephone">전화번호</label></th>
                                    <td><input type="text" name="b_telephone"
                                               value="<?php echo get_text($od['b_telephone']); ?>" id="b_telephone"
                                               class="frm_input"></td>
                                </tr>
                                <tr>
                                    <th scope="row"><label for="b_cellphone">핸드폰</label></th>
                                    <td><input type="text" name="b_cellphone"
                                               value="<?php echo get_text($od['b_cellphone']); ?>" id="b_cellphone"
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <input type="text" name="b_zip" value="<?php echo $od['b_zip']; ?>" id="b_zip"
                                               required class="frm_input required" size="5" maxlength="5">
                                        <button type="button" class="btn_small grey"
                                                onclick="win_zip('frmorderform2', 'b_zip', 'b_addr1', 'b_addr2', 'b_addr3', 'b_addr_jibeon');">
                                            주소검색
                                        </button>
                                        <br>
                                        <input type="text" name="b_addr1"
                                               value="<?php echo get_text($od['b_addr1']); ?>" id="b_addr1" required
                                               class="frm_input required" size="35">
                                        <label for="b_addr1">기본주소</label><br>
                                        <input type="text" name="b_addr2"
                                               value="<?php echo get_text($od['b_addr2']); ?>" id="b_addr2"
                                               class="frm_input" size="35">
                                        <label for="b_addr2">상세주소</label><br>
                                        <input type="text" name="b_addr3"
                                               value="<?php echo get_text($od['b_addr3']); ?>" id="b_addr3"
                                               class="frm_input" size="35">
                                        <label for="b_addr3">참고항목</label><br>
                                        <input type="hidden" name="b_addr_jibeon"
                                               value="<?php echo get_text($od['b_addr_jibeon']); ?>">
                                    </td>
                                </tr>
                                <tr>
                ...
                <div style="text-align: center">
                    <input type="checkbox" id="withSubscription" name="withSubscription" value="1">
                    <label for="withSubscription">체크시 구독정보 동시 변경</label>
                </div>
