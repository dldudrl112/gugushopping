...
<body<?php echo isset($tb['body_script']) ? $tb['body_script'] : ''; ?>>
	...
	<div class="header_mobile">
		<div class="sub_visual">
			<h3 class="back mob"><a href="javascript:history.back()"><img src="/img/header/back.png" alt="뒤로가기"><span>이용 약관</span></a></h3>
			<div style="border: 1px solid #f9f9f9;"></div>
			<div class="box">                                                                          
				<h2 class="sub-vis-tit">이용 약관</h2>
				<!-- 구독없을때 -->
			</div>
		</div>
	</div>
	...
	<div class="sub-visual1">
		<div class="box2">
			<p class="sub-vis-con"><span class="sub-vis-span">이용 약관</span></p>
		</div>
	</div>
		<div class="sub-page my-page sub07-02" id="section">
		    <div class="container">
			<!-- Mem_info Area Start -->
			<?
			...
			<div class="sub07-02-content-wrap content-wrap">
				<!-- Left_box Area Start -->
