...
$noti_url		=	TB_MSHOP_URL.'/inicis/settle_common.php';
$next_url	=	TB_MSHOP_URL.'/inicis/pay_approval.php';

//오토빌링 상품의 경우 
if($goods_item_count > 0){
	$return_url	=	TB_MSHOP_URL.'/inicis/pay_auto_return.php?oid=';
}else{
	$return_url	=	TB_MSHOP_URL.'/inicis/pay_return.php?oid=';
}