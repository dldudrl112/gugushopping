...
<div id="sit_qa_write" class="new_win">
	...
	<div class="tbl_frm01 tbl_wrap">
		...
		<tr>
			...
			<td><textarea name="iq_question" rows="10" required itemname="질문" style="width:100%;" class="frm_textbox wufll required"><?php echo $iq_question; ?></textarea></td>
		</tr>
		</tbody>
		</table>
	</div>
    ...
    <div class="win_btn">
        <input type="submit" value="문의하기" class="btn_lsmall">
