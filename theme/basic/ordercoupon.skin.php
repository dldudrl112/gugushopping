...
<div id="cp_list<?php echo $i; ?>" class="apply_cmd" style="display:none;">
	...
	<div class="coupon-pop">
		<h2>적용할 쿠폰선택</h2>
		<p>해당상품에 적용가능한 쿠폰입니다. 쿠폰을 선택해 주세요</p>
		<img src="<?php echo TB_IMG_URL; ?>/input-delete.png" alt="close" onclick="hide_cp_list('<?php echo $i; ?>'); return false;">
	</div>
...
function cp_submit() {
	...
	opener.document.getElementById("dc_amt").value = formatComma(f.sum_dc_amt.value);
