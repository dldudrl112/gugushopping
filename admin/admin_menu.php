...
//define('ADMIN_MENU1_08',	'선생님 관리');
define('ADMIN_MENU1_04',	'회원 일괄등록');
define('ADMIN_MENU1_05',	'월별 가입통계분석');
define('ADMIN_MENU1_06',	'일별 가입통계분석');
define('ADMIN_MENU1_07',	'포인트적립 현황');

define('ADMIN_MENU2',		'가맹점관리');
define('ADMIN_MENU2_01',	'가맹점 환경설정');
define('ADMIN_MENU2_02',	'가맹점 수수료정책');
define('ADMIN_MENU2_03',	'가맹점 신규신청');
define('ADMIN_MENU2_04',	'가맹점 연장신청');
define('ADMIN_MENU2_05',	'가맹점 전체목록');
define('ADMIN_MENU2_06',	'가맹점 수수료보기');
define('ADMIN_MENU2_07',	'가맹점 수수료정산');
define('ADMIN_MENU2_08',	'가맹점 수수료정산요청');
define('ADMIN_MENU2_09',	'가맹점 수수료내역');
define('ADMIN_MENU2_10',	'추천인변경 로그');
define('ADMIN_MENU2_11',	'가맹점 트리구조');
...
define('ADMIN_MENU5_12',	'빠른 적립포인트 수정');
