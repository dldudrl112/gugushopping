...
<body<?php echo isset($tb['body_script']) ? $tb['body_script'] : ''; ?>>
	...
	<div class="sub-visual1">
		<div class="box2">
			<p class="sub-vis-con"><span class="sub-vis-span">1:1문의</span> 입니다.</p>
		</div>
	</div>

<div class="sub-page my-page sub08-09 qna-page" id="section">
    <div class="container">
	<!-- Mem_info Area Start -->
	<? 
    // include_once(TB_THEME_PATH.'/aside_mem_info.skin.php');
     ?>
	<!-- Mem_info Area End -->
                <div class="sub08-09-content-wrap content-wrap">
			<!-- Left_box Area Start -->
			...
			<form class="qna-write-form" name="fqaform" id="fqaform" method="post" action="<?php echo $form_action_url; ?>" onsubmit="return fqaform_submit(this);" autocomplete="off">
			...
			<input type="hidden" name="token" value="<?php echo $token; ?>">
                            ...
                            <div class="detail-content-box">
                                    ...
                                    <textarea name="memo" cols="30" rows="10"  placeholder="내용을 입력해주세요"></textarea>
                                
                            </div>
                            </div>
                        </form>
                        <div class="btn-box">
                            <a href="javascript:fqaform.submit();" class="btn04">문의하기</a>                            
                            <a href="javascript:history.back()" class="btn05 gray">뒤로가기</a>
                        </div>
                    </div>
		</div><!-- content-wrap -->
	</div><!-- container -->
