...
<body<?php echo isset($tb['body_script']) ? $tb['body_script'] : ''; ?>>
	...
	<div class="header_mobile">
		<div class="sub_visual">
			<h3 class="back mob"><a href="javascript:history.back()"><img src="/img/header/back.png" alt="뒤로가기"><span>알람</span></a></h3>
			<div style="border: 1px solid #f9f9f9;"></div>
			<div class="box">
				<h2 class="sub-vis-tit">알람</h2>
				<!-- 구독없을때 -->
			</div>
		</div>
	</div>
	...
	<div class="sub-visual1">
		<div class="box2">
			<p class="sub-vis-con"><span class="sub-vis-span"><?php echo get_text($member['nickname']); ?></span> 님의 <br>찜 알람이에요.</p>
	...
	<div class="sub-page2 sub05-01" id="section">
		<div class="container">
			<!-- <div class="sub-visual">
				<h3 class="back mob"><a href="javascript:history.back()"><img src="<?php echo TB_IMG_URL; ?>/m-back.png" alt="뒤로가기"><span>알림</span></a></h3>
				<div class="box">
					<h2 class="sub-vis-tit">알림</h2>
					<p class="sub-vis-con">최근 30일 이내 알림만 제공합니다.</p>
				</div>
			</div>
			<!-- sub-visual --> 

			<div class="sub05-01-content-wrap">
				<div class="list-box">
					<ul>
						<?php
						$i = 0;
						if (is_array($list) == true) {
							for ($i = 0; $i < count($list); $i++) {
								...
								$secondDate	=	new DateTime($list[$i]["wdate"]);
								$intvl				=	$firstDate->diff($secondDate);

						?>
								<li>
									<div class="img-box"><img src="<?php echo TB_IMG_URL; ?>/alarm-new.png" alt="icon_alram" class="pc"><img src="<?php echo TB_IMG_URL; ?>/alarm-new-mob.png" alt="icon_alram" class="mob"></div>
									<div class="text-box">
										<p class="tit"><?= $list[$i]["subject"] ?></p>
										<p class="sub">
											<?
											if ($intvl->days > 0) {
												echo $intvl->days . "일전";
						...
						// <img src=\"" . TB_IMG_URL . "/icon_alram.png\" alt=\"icon_alram\">
						if ($i == 0) echo "<li><div class=\"ico_box\"></div><div class=\"text-box\"><p class=\"tit\">등록된 데이터가 없습니다.</p></div></li>";
						?>
					</ul>
					<p class="refer"><i>*</i>최근 30일 이내 알림만 제공합니다.</p>
				</div>
				<div class="btn-box">
