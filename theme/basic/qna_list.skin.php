...
<body<?php echo isset($tb['body_script']) ? $tb['body_script'] : ''; ?>>
	...
	<div class="sub-visual1">
		<div class="box2">
			<p class="sub-vis-con"><span class="sub-vis-span"><?php echo get_text($member['nickname']); ?></span> 님의 <br>문의 내역입니다.</p>
		</div>
	</div>


<div class="sub-page my-page sub08-07" id="section">
    <div class="container">
	<!-- Mem_info Area Start -->
	<?
	//  include_once(TB_THEME_PATH.'/aside_mem_info.skin.php');
	  ?>
	<!-- Mem_info Area End -->
                <div class="sub08-07-content-wrap content-wrap" style="display: flex;    justify-content: center;">
			<!-- Left_box Area Start -->
			...
			<!-- Left_box Area End -->
                    ...
                    <div class="content-box">                       
                        <h3><a href="javascript:history.back()"><img src="/img/m-back.png" alt="뒤로가기"></a>나의 문의내역</h3>
                        <div class="qna-box">
                            <!-- 내역 없을 때 -->
                            <!-- <div class="empty-box">문의 내역이 없습니다.</div> -->
				...
				?>
					<li>
					    <div class="subject" onclick="location.href='qna_read.php?index_no=<?=$row['index_no']?>';" style="cursor:pointer;"><?=$row['subject']?></div>
					    <div class="con">
						<span class="date"><?=$row['wdate']?></span>
						<span class="state"><?=$result_yes?></span>
					    </div>
					</li>
				<?php
				}
				if($i==0)
					echo '<li class="empty">문의 내역이 없습니다.</li>';
				?>	
                            </ul>                            
                        </div>
				<?php
				...
				?>
                        <div class="btn-box">
                            <a href="qna_write.php" class="btn01">1:1 문의하기</a>
                        </div>
                    </div>
		</div><!-- content-wrap -->
	</div><!-- container -->
