                    ...
                    <div class="list_box">
                        ...
                        <dl>
                            ...
                            <dd>
								...
								<div id="order_zip_wrap" style="display:none;border:1px solid;width:100%;height:300px;margin:5px 0;position:relative;overflow:auto;">
                        ...
                        <!-- 개인정보관련 -->
                        <div><?php echo $gs['memo2']; ?></div>

                    </div>
                </div><!-- Section2 Area End -->

                <!-- <div style="display:flex;" id="guest_agree">
                
                <input type="checkbox" id="agree" value="1" class="css-checkbox lrg">
                    <p style="margin: 5px 10px 0px;" for="agree" class="css-label">개인정보 수집 및 이용 내용을 읽었으며 이에 동의합니다.</p>
                </div> -->
