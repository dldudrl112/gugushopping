...
$i_price			=	get_session('tot_price'); // 결제금액
$i_usepoint		=	get_session('use_point'); // 포인트결제액
...
exit;
 ...
 if($od_settle_case == "휴대폰"){

    switch($default['de_pg_service']) {
        case 'inicis':
            include TB_SHOP_PATH.'/inicis/inipay_auto_result.php';
            break;
    }
